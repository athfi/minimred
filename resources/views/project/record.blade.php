                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div
                        ...
                        @if ($minim_errors)
                            ...
                            <ul class="mt-3 list-disc list-inside text-sm text-red-600 mb-8">
                                @foreach ($minim_errors as $error)
                    ...
                    >
                        ...
                        @if($record)
                            @if( $action =='randomise'  )
                                ...
                                @else
                                    <form method="POST"
                                          action="{{route('project.minimise', ['record_id' => $record['record_id'] ])}}">
                                        @csrf
